...
<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Admin Dashboard <small></small></h1>
			</div>
			<br>			
		</div>
	</div>
				...
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
					...
					<form method="post" id="postForm">							
						...
						<div class="form-group">
							<label for="title" class="control-label">Sanket No. or Citizenship No.</label>
							<input type="text" class="form-control" id="sanket" name="sanket" value="<?php echo $userDetails['sanket']; ?>" placeholder="Sanket No./Citizenship No.">							
						</div>
						<div class="form-group">
							<label for="title" class="control-label">Designation</label>
							<input type="text" class="form-control" id="designation" name="designation" value="<?php echo $userDetails['designation']; ?>" placeholder="Designation">							
						</div>
						<div class="form-group">
							<label for="title" class="control-label">Section</label>
							<input type="text" class="form-control" id="section" name="section" value="<?php echo $userDetails['section']; ?>" placeholder="Section">							
						</div>
						...
						<div class="form-group">
							...
							<label class="radio-inline">
								<input type="radio" name="user_type" id="author" value="2" <?php if($userDetails['type'] == 2) { echo "checked";} ?>>Employee
							</label>												
						</div>		
