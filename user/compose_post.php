				  ...
				  <div class="panel-body">
					...
					<form method="post" id="postForm">							
						...
						<div class="form-group">
							...
							<?php
							while ($title = $categories->fetch_assoc()) {
								$selected = '';
								if($title['name'] ==$postdetails['name']) {
									$selected = 'selected=selected';
								}									
								echo "<option value='".$title['name']."' $selected>".$title['name']."</option>";
							}
							?>							
							</select>
						</div>	
						<div class="form-group">
							...
							<textarea class="form-control" rows="5" id="message" name="message" placeholder="Post description.."required></textarea>					
						</div>	

						
							

                           <label for="pdate">Task date</label>
